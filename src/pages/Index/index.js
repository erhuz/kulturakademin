...
const Index = () => (
  <DefaultLayout>
    ...
    <HeroSlider slides={headerJson}/>
    <SwipeContainer title={"Rekommenderat"}/>
    <SwipeContainer title={"Senaste Uppladdningar"}/>
    <SwipeContainer title={"Webcasts"}/>
    <SwipeContainer title={"Podcasts"}/>
    <SwipeContainer title={"Digital Teknik"}/>
    <SwipeContainer title={"Dans"}/>
    <SwipeContainer title={"Teater"}/>
  </DefaultLayout>
);
